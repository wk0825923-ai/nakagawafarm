...
(async () => {
  ...
  set('farm_pesticides',[{id:1,name:'アディオン乳剤',reg_no:'R-18332',max_times:3,preharvest_days:7},{id:2,name:'ダコニール1000',reg_no:'R-9188',max_times:5,preharvest_days:14},{id:3,name:'モスピラン顆粒水溶剤',reg_no:'R-20115',max_times:2,preharvest_days:3},{id:4,name:'アドマイヤー1顆粒',reg_no:'R-19876',max_times:3,preharvest_days:7},{id:5,name:'プレバソンフロアブル5',reg_no:'R-22011',max_times:2,preharvest_days:1},{id:6,name:'ジュリボフロアブル',reg_no:'R-24188',max_times:1,preharvest_days:0}]);
  ...
  if(typeof INITIAL_GAP_CHECKS!=='undefined'){ set('farm_gap',INITIAL_GAP_CHECKS.map((c)=>({...c,is_cleared:false}))); }
